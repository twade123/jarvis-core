...
| Understanding the 17-seat boardroom architecture | `collective/models/boardroom-seat-mapping.md` (vault) |
| Claude Code subagent memory / concurrency | `references/claude-code-subagents.md` |
| Deep-dive into mlx_servers.sh guards, ports, dispatch | `references/mlx-servers-internals.md` |
| Ghost validator protocol (35B vs Anthropic comparison) | `collective/models/qwen3.5-35b/10-ghost-validator-protocol.md` (vault) |
| Kronos finetuning workflow (data prep → train → deploy) | `collective/kronos/06-finetuning-workflow.md` (vault) |
