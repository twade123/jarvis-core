...
```
Monthly failed payment MRR:        $<amount>
Current recovery rate:              30% ($<amount> recovered)
Target recovery rate:               60% ($<amount> recovered)
Monthly improvement:                $<amount>/month
Annual improvement:                 $<amount>/year
